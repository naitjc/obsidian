...
- [[116-xing-tsang-2024-co-guiding-for-multi-intent-spoken-language-understanding|Xing和Tsang - 2024 - Co-Guiding for Multi-Intent Spoken Language Understanding]]
...
- [[125-yin-2024-uni-mis-united-multiple-intent-spoken-language-understanding-via-multi-view-intent-slot-interaction|Yin 等 - 2024 - Uni-MIS United Multiple Intent Spoken Language Understanding via Multi-View Intent-Slot Interaction]]
- [[126-yin-2025-eclm-entity-level-language-model-for-spoken-language-understanding-with-chain-of-intent|Yin 等 - 2025 - ECLM Entity Level Language Model for Spoken Language Understanding with Chain of Intent]]
- [[127-yin-midlm-multi-intent-detection-with-bidirectional-large-language-models|Yin 等 - MIDLM Multi-Intent Detection with Bidirectional Large Language Models]]
- [[128-yoon-blendx-complex-multi-intent-detection-with-blended-patterns|Yoon 等 - BlendX Complex Multi-Intent Detection with Blended Patterns]]
- [[129-yu-2021-cross-domain-slot-filling-as-machine-reading-comprehension|Yu 等 - 2021 - Cross-Domain Slot Filling as Machine Reading Comprehension]]
