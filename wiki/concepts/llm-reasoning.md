...
- Scope: 52 source pages, including the completed 2026-05-05 direction set plus later safety, RAG, explanation-evaluation, multimodal-retrieval, hate-moderation reasoning, and ReAct tool-use reasoning additions through 2026-06-17.
