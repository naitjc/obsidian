...
- Scope: 63 hate-speech papers in this wiki direction.
...
- **Agentic and structured reasoning:** newer LLM moderation work suggests that agentic reasoning is useful only when anchored to controlled intermediate objects or uncertainty gates: community consultation, latent hate components, and DToT-style context refinement.
...
- **Generic debate vs structured verification:** [[193-sun-2026-rethinking-implicit-hate-speech-detection-focusing-on-latent-hate-components-via-dual-process-argumentation]] suggests that multi-agent debate over the whole post is weaker than first mining latent components and then deliberating over those components.
...
- Agentic/structured reasoning examples: [[192-gajewska-2026-improving-implicit-hate-speech-detection-via-a-community-driven-multi-agent-framework|Gajewska 等 - 2026 - Community-Driven Multi-Agent Framework]], [[193-sun-2026-rethinking-implicit-hate-speech-detection-focusing-on-latent-hate-components-via-dual-process-argumentation|Sun 等 - 2026 - DuPL]], [[194-zhang-2024-efficient-toxic-content-detection-by-bootstrapping-and-distilling-large-language-models|Zhang 等 - 2024 - DToT/BD-LLM]]
