...
sources:
  ...
  - raw/sources/20812_Process_vs_Outcome_Rewar.pdf
---
...
- [[196-zhang-2025-process-vs-outcome-reward-which-is-better-for-agentic-rag-reinforcement-learning]] moves supervision inside the agentic RAG loop: MCTS explores query, evidence, and answer actions; shortest-path reward estimates produce same-state preference pairs; and DPO trains the policy to choose better next steps.
...
- Retrieval as a learned action policy: train when to query, what evidence to extract, and when to stop, while keeping final-answer quality distinct from intermediate decision quality.
