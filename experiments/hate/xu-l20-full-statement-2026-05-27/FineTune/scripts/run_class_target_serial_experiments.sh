...
echo "[$(date '+%F %T')] Starting serial class_target in-domain experiments"
echo "[$(date '+%F %T')] Checking processed datasets: ihc, sbic"
...
echo "[$(date '+%F %T')] Processed data check completed"
...
echo "[$(date '+%F %T')] All serial class_target experiments completed"
