...
SBIC_TRAIN_FILE="${ROOT_DIR}/../../DATA/SBIC/processed/sbic_train_pure.json"
SBIC_VALID_FILE="${ROOT_DIR}/../../DATA/SBIC/processed/sbic_dev_pure.json"
SBIC_TEST_FILE="${ROOT_DIR}/../../DATA/SBIC/processed/sbic_test_pure.json"
